...
public class HtmlToTableExample {
    ...
    // 빈 문서를 활용, 빈 문서의 경로
    public static final String hwpBlankPath = "/upload" + File.separator + "blank.hwp";

    // 저장할 파일 경로
    public static final String hwpOutputPath = "/upload" + File.separator + "result-htmltohwp.hwp";
    ...
    private void run() {
        try {
            ...
            String html = new String(Files.readAllBytes(Paths.get("D://upload/tableExample.html")));
